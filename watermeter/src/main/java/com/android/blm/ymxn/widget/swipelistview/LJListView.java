package com.android.blm.ymxn.widget.swipelistview;
...
public class LJListView extends RelativeLayout implements OnScrollListener {
    ...
    private TextView infoHint = null; // 弹出的那个textview，提示框
    ...
    private void initWithContext(Context context) {
        ...
        mListView = (SwipeMenuListView) LayoutInflater.from(context).inflate(
                R.layout.ljlistview, null);
        // item侧滑需要
        mListView.setMenuCreator(creator);
        ...
        addView(mListView, new LayoutParams(LayoutParams.FILL_PARENT,
        ...
        infoHint = (TextView) LayoutInflater.from(context).inflate(
                R.layout.ljlistview_infohint, null);
    ...
    public void setOnMenuItemClickListener(SwipeMenuListView.OnMenuItemClickListener listener) {
        mListView.setOnMenuItemClickListener(listener);
    }
    ...
    /**
     * enable为true可以上拉加载，enable为false不可以上拉加载 str为显示在底部的文字，如果str为null或者"",就不显示
     *
     * @param enable
     * @param str
     */
    ...
    public void stopRefresh() {
        if (mPullRefreshing == true) {
            ...
            mHeaderView.setState(LJListViewHeader.STATE_FINISHED);
            new Handler().postDelayed(new Runnable() {
    ...
    SwipeMenuCreator creator = new SwipeMenuCreator() {
        public void create(SwipeMenu menu) {
            ...
            openItem.setBackground(new ColorDrawable(Color
                    .rgb(0xC9, 0xC9, 0xCE)));
            openItem.setWidth(DensityUtil.dip2px(context, 85));
            ...
            deleteItem.setBackground(new ColorDrawable(Color.rgb(0xF9, 0x3F,
                    0x25)));
            deleteItem.setWidth(DensityUtil.dip2px(context, 85));
