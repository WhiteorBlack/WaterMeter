package com.android.blm.ymxn.widget.silkcalendar;
...
//        setAdapter(new SimpleMonthAdapter(getContext(), mController, typedArray));
...
//        adjustHeight();
    ...
    public void setSelectDay(SimpleMonthAdapter.CalendarDay calendar){
